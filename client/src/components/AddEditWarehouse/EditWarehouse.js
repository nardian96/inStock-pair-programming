...
export default class EditWarehouse extends Component {
  ...
  render() {
    let selectedWarehouse = this.props.warehouses.filter(
      (a) => a.id === this.props.match.params.warehouseId
    )[0];
        ...
        <div className="warehouse__list-big-container">
          ...
          >
              ...
              <section className="warehouse__subsection">
                ...
                <div className="warehouse__input-container">
                  ...
                  <textarea
                    name="contactName"
                    className="warehouse__input-box"
                    defaultValue={selectedWarehouse.contact.name}
                  ></textarea>
                </div>
                <div className="warehouse__input-container">
                  <h3>Position</h3>
                  <textarea
                    ...
                    className="warehouse__input-box"
                    defaultValue={selectedWarehouse.contact.position}
                  ></textarea>
                </div>
                <div className="warehouse__input-container">
                  <h3>Phone Number</h3>
                  <textarea
                    name="contactPhone"
                    className="warehouse__input-box"
                    defaultValue={selectedWarehouse.contact.phone}
                  ></textarea>
                </div>
                <div className="warehouse__input-container">
                  <h3>Email</h3>
                  <textarea
                    name="contactEmail"
                    className="warehouse__input-box"
                    defaultValue={selectedWarehouse.contact.email}
                  ></textarea>
                </div>
              </section>
            </div>
            <div className="warehouse__button-container">
              ...
              <button className="warehouse__small-button warehouse__small-button--blue">
                Save
              </button>
            </div>
          </form>
